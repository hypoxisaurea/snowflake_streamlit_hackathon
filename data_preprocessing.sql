...
SELECT * FROM POPULATION_KOR_LABELING;
...
-- LOC_TYPE=1,2 각각 처리해서 저장
CREATE TABLE MY_HACKATHON_DB.PUBLIC.DEPT_HOME_RATIO AS
SELECT * FROM RESIDENTIAL__WORKPLACE_TRAFFIC_PATTERNS_FOR_SNOWFLAKE_STREAMLIT_HACKATHON.PUBLIC.SNOWFLAKE_STREAMLIT_HACKATHON_LOPLAT_HOME_OFFICE_RATIO
WHERE LOC_TYPE = 1;


CREATE TABLE MY_HACKATHON_DB.PUBLIC.DEPT_WORK_RATIO AS
SELECT * FROM RESIDENTIAL__WORKPLACE_TRAFFIC_PATTERNS_FOR_SNOWFLAKE_STREAMLIT_HACKATHON.PUBLIC.SNOWFLAKE_STREAMLIT_HACKATHON_LOPLAT_HOME_OFFICE_RATIO
WHERE LOC_TYPE = 2;

SELECT * FROM DEPT_HOME_RATIO;
SELECT * FROM DEPT_WORK_RATIO;